...
final class Version00000000000000 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tag ADD CONSTRAINT FK_389B7839D25CF90 FOREIGN KEY (replacement_id) REFERENCES tag (id) ON DELETE SET NULL');
        $this->addSql('CREATE INDEX IDX_389B7839D25CF90 ON tag (replacement_id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FEF0481D2B36786B ON badge (title)');
        ...
        // VISITS
        $this->addSql('CREATE TABLE visit (id INT UNSIGNED AUTO_INCREMENT NOT NULL, article_id INT UNSIGNED DEFAULT NULL, tag_id INT UNSIGNED DEFAULT NULL, file_id INT UNSIGNED DEFAULT NULL, user_id INT UNSIGNED DEFAULT NULL, ip_address VARCHAR(45) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_C12294787294869C (article_id), INDEX IDX_C1229478BAD26311 (tag_id), INDEX IDX_C122947893CB796C (file_id), INDEX IDX_C1229478A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE visit ADD CONSTRAINT FK_C12294787294869C FOREIGN KEY (article_id) REFERENCES article (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE visit ADD CONSTRAINT FK_C1229478BAD26311 FOREIGN KEY (tag_id) REFERENCES tag (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE visit ADD CONSTRAINT FK_C122947893CB796C FOREIGN KEY (file_id) REFERENCES file (id) ON DELETE CASCADE');
    }
