...
{
    const int HOME_TOTAL_PAGES          = 166;  // 👀 https://turbolab.it/#contact
    const int NEWS_TOTAL_PAGES          = 43;   // 👀 https://turbolab.it/news#contact
    ...
    const int USER_ZANE_TOTAL_PAGES     = 44;   // 👀 https://turbolab.it/utenti/zane#contact
